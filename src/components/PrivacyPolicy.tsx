  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-surface border border-line rounded-xl p-5 space-y-5 text-sm text-ink leading-relaxed">
        ...
        <section>
          <h2 className="font-semibold text-ink text-base mb-2">Analytics</h2>
          <p>
        ...
        <section>
          <h2 className="font-semibold text-ink text-base mb-2">Feedback Form</h2>
          <p>
        ...
        <section>
          <h2 className="font-semibold text-ink text-base mb-2">Third-Party Links</h2>
          <p>
        ...
        <section>
          <h2 className="font-semibold text-ink text-base mb-2">Children's Privacy</h2>
          <p>
        ...
        <section>
          <h2 className="font-semibold text-ink text-base mb-2">Changes to This Policy</h2>
          <p>
        ...
        <section>
          ...
          <p>
            If you have any questions about this privacy policy, please reach out via the feedback button on the Dashboard.
          </p>
        </section>
      </div>
    </div>
